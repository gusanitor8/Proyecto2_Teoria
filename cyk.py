...
'''
Test cyk
w = 'bbba' #cadena a testear
result , node, t = parse_sentence_cyk(w , grammarFNC) #grammarFNC es la gramatica en FNC
if result:
    print(f"The string '{s}' is generated by the grammar.")
    print(f"Time for approve: {t:.6f} seconds")
else:
    print(f"The string '{s}' is not generated by the grammar.")
    print(f"Time for reject: {t:.6f} seconds")
